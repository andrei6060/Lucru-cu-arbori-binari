...
void test_insert(TTree** tree) {
	...
	// printf("%ld\n\n", *((long*)(*tree)->root->left->prev->elem));

	// printf("%ld\n", *((long*)(*tree)->root->left->left->next->elem));
	// if((*tree)->root->left->left->prev)
	// 	printf("%ld\n\n", *((long*)(*tree)->root->left->prev->elem));
	// else
	// 	printf("e bn\n\n");

	// printf("%ld\n", *((long*)(*tree)->root->left->right->next->elem));
	// printf("%ld\n\n", *((long*)(*tree)->root->left->right->prev->elem));

	// printf("%ld\n", *((long*)(*tree)->root->right->next->elem));
	// printf("%ld\n\n", *((long*)(*tree)->root->right->prev->elem));

	// printf("%ld\n", *((long*)(*tree)->root->right->left->next->elem));
	// printf("%ld\n\n", *((long*)(*tree)->root->right->left->prev->elem));

	// printf("%ld\n", *((long*)(*tree)->root->right->right->next->elem));
	// printf("%ld\n\n", *((long*)(*tree)->root->right->right->prev->elem));


	// if((*tree)->root->right->right->right->next)
	// 	printf("%ld\n", *((long*)(*tree)->root->right->right->right->next->elem));
	
	// else
	// 	printf("e bn\n");
	// printf("%ld\n\n", *((long*)(*tree)->root->right->right->right->prev->elem));

	// printf("%ld\n", *((long*)(*tree)->root->right->right->left->next->elem));
	// printf("%ld\n\n", *((long*)(*tree)->root->right->right->left->prev->elem));
...
void test_delete(TTree** tree) {
	...
	// printf("%ld\n",*((long*)(*tree)->root->right->elem));
	// printf("%ld\n\n",*((long*)(*tree)->root->right->prev->elem));

	// printf("%ld\n",*((long*)(*tree)->root->right->left->elem));
	// printf("%ld\n",*((long*)(*tree)->root->right->left->prev->elem));
	// printf("%ld\n",*((long*)(*tree)->root->right->left->next->elem));
	// printf("-----------------------\n");
	//return;
